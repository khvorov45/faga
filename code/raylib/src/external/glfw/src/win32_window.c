...
// NOTE(khvorov) Window flashes white on creation and this is the best I can do to avoid it
#if HACKY_WHITE_FLASH_FIX
    ...
    if (!window->monitor)
    {
        ...
        // NOTE(khvorov) If I hide the window with its janky transparent background
        // it will be shown with a white background.
        #ifndef HACKY_WHITE_FLASH_FIX
        wp.showCmd = SW_HIDE;
        #endif
